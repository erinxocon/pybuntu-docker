...
build_jammy: build_jammy_3.7.16 build_jammy_3.8.16 build_jammy_3.9.16 build_jammy_3.10.11 build_jammy_3.11.3 #build_jammy_3.12.0a7
	@echo 'All jammy based images built!'

build_focal: build_focal_3.7.16 build_focal_3.8.16 build_focal_3.9.16 build_focal_3.10.11 build_focal_3.11.3 #build_focal_3.12.0a7
	@echo 'All focal based images built!'

build_bionic: build_bionic_3.7.16 build_bionic_3.8.16 build_bionic_3.9.16 build_bionic_3.10.11 build_bionic_3.11.3 #build_bionic_3.12.0a7
...
push_jammy:
	...
	# @docker push jetblackpope/pybuntu:3.12.0a7-jammy-$(ARCH)
	@docker push jetblackpope/pybuntu:3.11.3-jammy-$(ARCH)
	@docker push jetblackpope/pybuntu:3.10.11-jammy-$(ARCH)
...
push_focal:
	...
	# @docker push jetblackpope/pybuntu:3.12.0a7-focal-$(ARCH)
	@docker push jetblackpope/pybuntu:3.11.3-focal-$(ARCH)
	@docker push jetblackpope/pybuntu:3.10.11-focal-$(ARCH)
...
push_bionic:
	...
	# @docker push jetblackpope/pybuntu:3.12.0a7-bionic-$(ARCH)
	@docker push jetblackpope/pybuntu:3.11.3-bionic-$(ARCH)
	@docker push jetblackpope/pybuntu:3.10.11-bionic-$(ARCH)
...
manifest_jammy: manifest_jammy_3.7.16 manifest_jammy_3.8.16 manifest_jammy_3.9.16 manifest_jammy_3.10.11 manifest_jammy_3.11.3 #manifest_jammy_3.12.0a7
...
manifest_bionic: manifest_bionic_3.7.16 manifest_bionic_3.8.16 manifest_bionic_3.9.16 manifest_bionic_3.10.11 manifest_bionic_3.11.3 #manifest_bionic_3.12.0a7
...
manifest_focal: manifest_focal_3.7.16 manifest_focal_3.8.16 manifest_focal_3.9.16 manifest_focal_3.10.11 manifest_focal_3.11.3 #manifest_focal_3.12.0a7
...
push_manifest_jammy: push_manifest_jammy_3.7.16 push_manifest_jammy_3.8.16 push_manifest_jammy_3.9.16 push_manifest_jammy_3.10.11 push_manifest_jammy_3.11.3 #push_manifest_jammy_3.12.0a7
...
push_manifest_bionic: push_manifest_bionic_3.7.16 push_manifest_bionic_3.8.16 push_manifest_bionic_3.9.16 push_manifest_bionic_3.10.11 push_manifest_bionic_3.11.3 #push_manifest_bionic_3.12.0a7
...
push_manifest_focal: push_manifest_focal_3.7.16 push_manifest_focal_3.8.16 push_manifest_focal_3.9.16 push_manifest_focal_3.10.11 push_manifest_focal_3.11.3 #push_manifest_focal_3.12.0a7
...
push_manifest: push_manifest_bionic push_manifest_focal push_jammy
	...
	@docker manifest create jetblackpope/pybuntu:latest --amend jetblackpope/pybuntu:3.11.3-jammy-arm64 --amend jetblackpope/pybuntu:3.11.3-jammy-x86_64

	@docker manifest create jetblackpope/pybuntu:3.11-jammy --amend jetblackpope/pybuntu:3.11.3-jammy-arm64 --amend jetblackpope/pybuntu:3.11.3-jammy-x86_64
	@docker manifest push jetblackpope/pybuntu:3.11-jammy

	@docker manifest create jetblackpope/pybuntu:3.10-jammy --amend jetblackpope/pybuntu:3.10.11-jammy-arm64 --amend jetblackpope/pybuntu:3.10.11-jammy-x86_64
	...
	@docker manifest create jetblackpope/pybuntu:3.11-focal --amend jetblackpope/pybuntu:3.11.3-focal-arm64 --amend jetblackpope/pybuntu:3.11.3-focal-x86_64
	@docker manifest push jetblackpope/pybuntu:3.11-focal

	@docker manifest create jetblackpope/pybuntu:3.10-focal --amend jetblackpope/pybuntu:3.10.11-focal-arm64 --amend jetblackpope/pybuntu:3.10.11-focal-x86_64
	...
	@docker manifest create jetblackpope/pybuntu:3.11-bionic --amend jetblackpope/pybuntu:3.11.3-bionic-arm64 --amend jetblackpope/pybuntu:3.11.3-bionic-x86_64
	@docker manifest push jetblackpope/pybuntu:3.11-bionic

	@docker manifest create jetblackpope/pybuntu:3.10-bionic --amend jetblackpope/pybuntu:3.10.11-bionic-arm64 --amend jetblackpope/pybuntu:3.10.11-bionic-x86_64
